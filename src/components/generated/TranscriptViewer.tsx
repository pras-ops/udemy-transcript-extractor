...
export const TranscriptViewer = ({
  ...
  // @return
  return <SortableContainer dndKitId="b3f3ca15-ccc1-430f-a062-3a0f892f8339" containerType="regular" prevTag="div" className="flex-1 flex flex-col" data-magicpath-id="3" data-magicpath-path="TranscriptViewer.tsx">
      <SortableContainer dndKitId="331f6016-c548-4ef7-9f22-e72848ffaf0e" containerType="regular" prevTag="div" className="p-4 border-b border-gray-200 dark:border-gray-700" data-magicpath-id="4" data-magicpath-path="TranscriptViewer.tsx">
        <SortableContainer dndKitId="1ef28b9f-15e2-458d-b73f-372c7a076c58" containerType="regular" prevTag="div" className="relative" data-magicpath-id="5" data-magicpath-path="TranscriptViewer.tsx">
      ...
      <SortableContainer dndKitId="e0bc9f44-9bd2-46bb-883a-2e4bff183bc2" containerType="regular" prevTag="div" className="flex-1 overflow-y-auto" data-magicpath-id="8" data-magicpath-path="TranscriptViewer.tsx">
        {isExtracting ? <SortableContainer dndKitId="29c12a86-bdfe-4969-b71d-96318ed3253c" containerType="regular" prevTag="div" className="flex flex-col items-center justify-center h-full text-gray-500 dark:text-gray-400 p-8" data-magicpath-id="9" data-magicpath-path="TranscriptViewer.tsx">
          ...
          </SortableContainer> : isEmpty ? <SortableContainer dndKitId="1c0ae804-fb33-46e3-b892-377190a53e4b" containerType="regular" prevTag="div" className="flex flex-col items-center justify-center h-full text-gray-500 dark:text-gray-400 p-8" data-magicpath-id="15" data-magicpath-path="TranscriptViewer.tsx">
          ...
          </SortableContainer> : transcript.length === 0 ? <SortableContainer dndKitId="e7784139-e302-44b0-8943-d256a0dbb590" containerType="regular" prevTag="div" className="flex flex-col items-center justify-center h-full text-gray-500 dark:text-gray-400 p-8" data-magicpath-id="21" data-magicpath-path="TranscriptViewer.tsx">
          ...
          </SortableContainer> : <SortableContainer dndKitId="400ea6b5-2389-4941-b4ca-84f3e8040fc7" containerType="collection" prevTag="div" className="p-4 space-y-3" data-magicpath-id="25" data-magicpath-path="TranscriptViewer.tsx">
