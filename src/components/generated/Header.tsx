...
export const Header = ({
  ...
  // @return
  return <SortableContainer dndKitId="3e1b5e64-f101-4e88-ba7d-6db18c42f4e3" containerType="regular" prevTag="header" className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600" data-magicpath-id="0" data-magicpath-path="Header.tsx">
      <SortableContainer dndKitId="cfa93ab2-3937-41c9-a5cb-332cca026eb5" containerType="regular" prevTag="div" className="flex items-center space-x-3" data-magicpath-id="1" data-magicpath-path="Header.tsx">
        <SortableContainer dndKitId="b51ccbac-dd99-46b9-9881-8a0ddd8b4d7a" containerType="regular" prevTag="div" className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm" data-magicpath-id="2" data-magicpath-path="Header.tsx">
          <FileText className="w-5 h-5 text-blue-600 dark:text-blue-400" data-magicpath-id="3" data-magicpath-path="Header.tsx" />
        </SortableContainer>
        <SortableContainer dndKitId="ce03a165-a163-4e34-8cd7-9d76b0d29947" containerType="regular" prevTag="div" data-magicpath-id="4" data-magicpath-path="Header.tsx">
