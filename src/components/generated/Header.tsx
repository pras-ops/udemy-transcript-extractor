...
export const Header = ({
  ...
  // @return
  return <SortableContainer dndKitId="26996cd9-2d9c-4b62-bc62-4335d7e47928" containerType="regular" prevTag="header" className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600" data-magicpath-id="0" data-magicpath-path="Header.tsx">
      <SortableContainer dndKitId="00b0ebc2-ad5b-46b9-a883-1c0e0bb44a71" containerType="regular" prevTag="div" className="flex items-center space-x-3" data-magicpath-id="1" data-magicpath-path="Header.tsx">
        <SortableContainer dndKitId="56c0a15e-2bdb-4976-b943-a9a906663ddb" containerType="regular" prevTag="div" className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm" data-magicpath-id="2" data-magicpath-path="Header.tsx">
          <FileText className="w-5 h-5 text-blue-600 dark:text-blue-400" data-magicpath-id="3" data-magicpath-path="Header.tsx" />
        </SortableContainer>
        <SortableContainer dndKitId="9722e3a4-1efc-44f2-a66e-6f82d55bbeaf" containerType="regular" prevTag="div" data-magicpath-id="4" data-magicpath-path="Header.tsx">
